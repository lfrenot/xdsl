...
class SnitchRuntimeGetInfo(SnitchRuntimeBaseOperation, ABC):
    ...
    result = result_def(Annotated[IntegerType, i32])
...
class GetMemoryInfoBaseOperation(SnitchRuntimeBaseOperation, ABC):
    ...
    slice_begin = result_def(Annotated[IntegerType, slice_t_begin])
    slice_end = result_def(Annotated[IntegerType, slice_t_end])
...
class DmaStart1DBaseOperation(SnitchRuntimeBaseOperation, Generic[_T], ABC):
    ...
    transfer_id = result_def(Annotated[IntegerType, tx_id])
